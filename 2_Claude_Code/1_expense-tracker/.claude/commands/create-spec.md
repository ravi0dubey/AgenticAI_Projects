---
description: Create a spec file and feature branch for the next Expense_Tracker step
...
Expense_Tracker expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the Expense_Tracker roadmap.
