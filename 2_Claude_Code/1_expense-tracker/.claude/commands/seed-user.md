...
1. Generates a realistic random Canadian user using your 
   own knowledge of common Canadian names across regions:
   - Name: a realistic Canadian first + last name
   - Email: derived from the name with a random 2-3 digit 
     number suffix (e.g. tood.north@gmail.com)
